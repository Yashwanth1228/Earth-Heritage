...
const TEMP_USER_DATA = path.join(os.tmpdir(), 'chrome_cdp_mf_' + Date.now());
...
async function main() {
  ...
  const chromeProc = spawn(CHROME_PATH, [
    ...
    'http://localhost:3000/managed-farmland'
  ]);
  ...
  try {
    ...
    const d1 = await evaluate(`
      (() => {
        ...
        return { bodyWidth, scrollWidth, innerWidth, hasOverflow, title, hero, cta };
      })()
    `);
    ...
    const shotPathDesktop = 'C:\\Users\\Admin\\.gemini\\antigravity-ide\\brain\\4f0fd464-7ce7-4038-a5be-4411227ab03c\\scratch\\mf_desktop_1440.png';
    ...
    console.log('\n=== TEST 2: Test Modal Open via "Talk to Earth Heritage" ===');
    ...
    const shotPathMobile = 'C:\\Users\\Admin\\.gemini\\antigravity-ide\\brain\\4f0fd464-7ce7-4038-a5be-4411227ab03c\\scratch\\mf_mobile_390.png';
