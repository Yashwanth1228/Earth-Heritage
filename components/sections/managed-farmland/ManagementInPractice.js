...
/**
 * Section 6 — What Management Means in Practice
 * 
 * Heading: "Management means staying connected to the land."
 * 
 * Highlights 7 Core Operational Pillars:
 * 01 Clear coordination
 * 02 Responsible farm care
 * 03 Planned cultivation
 * 04 Ongoing maintenance
 * 05 Farm operations
 * 06 Harvest coordination
 * 07 Transparent communication
 */
export default function ManagementInPractice() {
  const { eyebrow, heading, supportingCopy, pillars } =
    managedFarmlandData.managementInPractice;

  return (
    <section
      id="management-in-practice"
      ...
      aria-label="What Management Means in Practice"
    >
      ...
      <Container size="default" className="relative z-10">
        ...
        {/* 7 Operational Pillars Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
          {pillars.map((pillar, idx) => (
            <MotionReveal key={pillar.number} delay={0.08 + idx * 0.05}>
              <div className="h-full p-6 sm:p-7 rounded-2xl bg-white/85 border border-[#D5C09D] hover:border-[#1E460B]/60 transition-all duration-300 shadow-[0_4px_16px_rgba(17,22,19,0.03)] hover:shadow-[0_8px_24px_rgba(17,22,19,0.06)] flex flex-col justify-between backdrop-blur-xs group">
                <div>
