...
/**
 * Section 10 — Final Enquiry CTA for /managed-farmland
 * 
 * Heading: "Your land deserves thoughtful care."
 * Supporting: "Explore how Earth Heritage can help manage your farmland with care, coordination and purpose."
 * Action: "Talk to Earth Heritage" -> Opens existing EnquiryModal with "Managed Farmland" preselected.
 */
export default function ManagedFarmlandCta() {
  const { openEnquiryModal } = useEnquiry();
  const { eyebrow, heading, supportingCopy, buttonText } = managedFarmlandData.cta;
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <MotionReveal delay={0.4}>
            <p className="mt-6 font-mono text-xs text-[#5E6960] tracking-wider uppercase">
              Confidential · Titled Land Ownership · Responsible Stewardship
            </p>
          </MotionReveal>
