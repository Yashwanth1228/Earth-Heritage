...
/**
 * Section 1 — Editorial Introduction for /how-it-works
 * 
 * Eyebrow: HOW IT WORKS
 * Heading: From Land Ownership to Ongoing Farm Care.
 * Description: Show visitors how Earth Heritage brings together land ownership and professional farm management through a clear, connected process.
 */
export default function HowItWorksIntro() {
  const { eyebrow, headingPart1, headingPart2, description } = howItWorksData.intro;

  return (
    <section
      id="hero"
      className="relative bg-[#FAF6F0] text-[#111613] pt-24 sm:pt-28 lg:pt-32 pb-14 sm:pb-20 border-b border-[#DCCDB7] overflow-hidden"
      aria-label="How Earth Heritage Managed Farmland Works Introduction"
    >
