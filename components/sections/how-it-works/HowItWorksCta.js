...
/**
 * Section 7 — Final Enquiry CTA for /how-it-works
 * 
 * Heading: "Ready to explore what managed farmland could look like for you?"
 * Supporting: "Speak with Earth Heritage to learn more about the managed farmland model and how farm management works."
 * Action: "Talk to Us" -> Opens existing EnquiryModal with "How It Works" interest.
 */
export default function HowItWorksCta() {
  const { openEnquiryModal } = useEnquiry();
  const { eyebrow, heading, supportingCopy, buttonText } = howItWorksData.cta;

  return (
    <section
      id="cta"
      className="relative bg-[#FAF6F0] text-[#111613] pt-16 sm:pt-24 lg:pt-28 pb-20 sm:pb-28 lg:pb-32 overflow-hidden"
      aria-label="Contact Earth Heritage Regarding the Process"
    >
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <MotionReveal delay={0.35}>
            <div className="mt-10 sm:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                type="button"
                onClick={(e) => openEnquiryModal('How It Works', e.currentTarget)}
